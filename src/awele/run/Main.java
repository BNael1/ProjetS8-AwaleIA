            ...
            try {
                ...
                if (bot != null) {
                    ...
                    if (runningTime > Main.MAX_LEARNING_TIME)
                        ...
                        awele.play();
                        long decisionTime = (long) ((2 * awele.getRunningTime()) / awele.getNbMoves())
                                - randomAverageDecisionTime;
